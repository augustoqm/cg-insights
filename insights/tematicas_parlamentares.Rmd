...
```{r ementas_per_govern, echo=FALSE, fig.height = 6}
...
```{r theme_per_govern, echo=FALSE, fig.height = 13}
...
```{r wordcloud_govern_past, echo=FALSE, fig.width = 8, fig.height = 8}
...
```{r wordcloud_govern_cur, echo=FALSE, fig.width = 8, fig.height = 8}
